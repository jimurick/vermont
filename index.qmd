...
-   If you want to run the Shiny app, follow the instructions in [`hospitalstars`](https://github.com/jimurick/hospitalstars?tab=readme-ov-file#installation) to install that R package.
