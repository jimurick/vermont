...
-   R
    ...
    -   [ggplot2](https://ggplot2-book.org/) gives an overview of how the `ggplot2` package works
    ...
    -   [Tidy Modeling with R](https://www.tmwr.org/) is a very good intro to `tidymodels` and organizing basic machine learning model projects
-   Other
