...
-   [include-in-header](https://quarto.org/docs/output-formats/html-basics.html#includes) adds two scripts from the notebook's folder to the HTML header, one javascript and one CSS

## MathJax Macros

The file `{r} repo_link("quarto_example.qmd", "examples/quarto/latex.js")` sets this Javascript object:
...
Code chunk options are generally part of the [`knitr`](https://yihui.org/knitr/) package (see for example [this page](https://bookdown.org/yihui/rmarkdown-cookbook/figure-size.html)).
