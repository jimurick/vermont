...
-   [include-in-header](https://quarto.org/docs/output-formats/html-basics.html#includes) adds two scripts from the notebook's folder to the HTML header, one javascript and one CSS, and links to google's [Fira Code](https://fonts.google.com/specimen/Fira+Code) font.
